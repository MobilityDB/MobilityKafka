...
public class Query5_Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            props.put(StreamsConfig.APPLICATION_ID_CONFIG, "query5_AIS");
            ...
            return new Processor<Windowed<String>, Object, String, String>() {
                ...
                public void process(Record<Windowed<String>, Object> record) {
                    ...
                    String alert = String.format(
                            "[ALERT][Q5] MMSI=%-12s | avgSpeed=%6.2f m/s (>%.1f) | minSpeed=%6.2f m/s (>%.1f)"
        ...
        public Processor<Windowed<String>, Object, String, String> get() {
            return new Processor<Windowed<String>, Object, String, String>() {
                ...
                public void process(Record<Windowed<String>, Object> record) {
                    ...
                    String alert = String.format(
                            "[ALERT][Q5][V2] MMSI=%-12s | avgSpeed=%6.2f m/s (>%.1f)"
                                    + " | minSpeed=%6.2f m/s (>%.1f) | points=%d | trigger=%s"
                                    + " | window [%s - %s]%n"
                                    + "             trajectory: %s",
                            mmsi, avgSpeedMs, avgSpeedThresholdMs, minSpeedMs, minSpeedThresholdMs,
