...
public class SNCBData {
    ...
    public static SNCBData fromCsv(String row) {
        ...
        data.setGpsSpeed(Double.parseDouble(cols[11].trim()));
        data.setPcfaMbar(Double.parseDouble(cols[3].trim()));
        data.setPcffMbar(Double.parseDouble(cols[4].trim()));
        data.setVbat(Double.parseDouble(cols[2].trim()));
        data.setPcf1Mbar(Double.parseDouble(cols[5].trim()));
        data.setPcf2Mbar(Double.parseDouble(cols[6].trim()));
        data.setT1Mbar(Double.parseDouble(cols[7].trim()));
        data.setT2Mbar(Double.parseDouble(cols[8].trim()));
        data.setCode1(Double.parseDouble(cols[9].trim()));
        data.setCode2(Double.parseDouble(cols[10].trim()));
        return data ;
    }
