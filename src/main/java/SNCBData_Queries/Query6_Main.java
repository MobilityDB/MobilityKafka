...
public class Query6_Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            props.put(StreamsConfig.APPLICATION_ID_CONFIG, "query6_SNCB");
            ...
            KStream<String, String> gps = stream1
                    ...
                    .map((key, value) -> {
                        ...
                        return new KeyValue<>(cols[1].trim(), value); // DeviceID as key
                    });
        ...
        public Processor<String, Object, String, String> get() {
            return new Processor<String, Object, String, String>() {
                ...
                public void process(org.apache.kafka.streams.processor.api.Record<String, Object> record) {
                    ...
                    SNCBData left = SNCBData.fromCsv(rows[0]);
                    SNCBData right = SNCBData.fromCsv(rows[1]);
                    ...
                    if (tpointLeft == null || tpointRight == null) {
                        log.error("tgeogpoint_in returned null for pair DeviceID={}", left.getDeviceId());
                        return ;
                    }
                    ...
                    log.info(result);
                    context.forward(new Record<>(String.valueOf(left.getDeviceId()), result, record.timestamp()));
