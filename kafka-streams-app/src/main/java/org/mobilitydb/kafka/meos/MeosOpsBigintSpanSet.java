...
public final class MeosOpsBigintSpanSet {
     ...
     */
    public static Pointer bigintspanset_bins(Pointer arg0, long arg1, long arg2, Pointer arg3) {
        if (!MEOS_AVAILABLE) {
     ...
     * <p>Classification: role=accessor</p>
     */
    public static long bigintspanset_lower(Pointer arg0) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static Pointer bigintspanset_shift_scale(Pointer arg0, long arg1, long arg2, boolean arg3, boolean arg4) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static long bigintspanset_upper(Pointer arg0) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static long bigintspanset_width(Pointer arg0, boolean arg1) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
