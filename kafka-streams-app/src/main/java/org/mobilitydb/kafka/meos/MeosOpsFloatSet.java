...
public final class MeosOpsFloatSet {
     ...
     * <p>Classification: role=accessor</p>
     */
    public static Pointer floatset_degrees(Pointer arg0, boolean arg1) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static Pointer floatset_shift_scale(Pointer arg0, double arg1, double arg2, boolean arg3, boolean arg4) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static Pointer floatset_value_n(Pointer arg0, int arg1) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
