 ...
 * Methods emitted: 10 (bounded-state=5 · io-meta=3 · stateless=1 · windowed=1)
...
public final class MeosOpsTSpatial {
     ...
     * <p>Classification: role=accessor</p>
     */
    public static Pointer tspatial_transform_pipeline(Pointer arg0, String arg1, int arg2, boolean arg3) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
    ...
    /**
     * MEOS {@code tspatial_type} — tier <b>bounded-state</b>.
     * <p>Per-event with bounded per-key state (MEOS handle).</p>
     * <p>Object-model role: {@code accessor}.</p>
     * <p>Classification: role=accessor</p>
     */
    public static boolean tspatial_type(int arg0) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
                "tspatial_type requires libmeos — set -Dmobilityflink.meos.enabled=true");
        }
        return GeneratedFunctions.tspatial_type(arg0);
    }
