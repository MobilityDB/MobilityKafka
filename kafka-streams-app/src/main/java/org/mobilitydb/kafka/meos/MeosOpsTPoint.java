 ...
 * Methods emitted: 25 (bounded-state=21 · stateless=2 · windowed=2)
...
public final class MeosOpsTPoint {
     ...
     */
    public static Pointer tpoint_tfloat_to_geomeas(Pointer arg0, Pointer arg1, boolean arg2) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static boolean tpoint_as_mvtgeom(Pointer arg0, Pointer arg1, int arg2, int arg3, boolean arg4, Pointer arg5, Pointer arg6, Pointer arg7) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static Pointer tpoint_direction(Pointer arg0) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static boolean tpoint_is_simple(Pointer arg0) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static Pointer tpoint_trajectory(Pointer arg0, boolean arg1) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
    ...
    /**
     * MEOS {@code tpoint_type} — tier <b>bounded-state</b>.
     * <p>Per-event with bounded per-key state (MEOS handle).</p>
     * <p>Object-model role: {@code accessor}.</p>
     * <p>Classification: role=accessor</p>
     */
    public static boolean tpoint_type(int arg0) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
                "tpoint_type requires libmeos — set -Dmobilityflink.meos.enabled=true");
        }
        return GeneratedFunctions.tpoint_type(arg0);
    }
