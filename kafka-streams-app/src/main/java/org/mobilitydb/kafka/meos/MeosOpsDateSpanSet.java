...
public final class MeosOpsDateSpanSet {
     ...
     * <p>Classification: role=accessor</p>
     */
    public static Pointer datespanset_date_n(Pointer arg0, int arg1) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static Pointer datespanset_duration(Pointer arg0, boolean arg1) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static Pointer datespanset_shift_scale(Pointer arg0, int arg1, int arg2, boolean arg3, boolean arg4) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
