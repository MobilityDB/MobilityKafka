...
public final class MeosOpsTNpoint {
     ...
     * <p>Classification: role=restriction</p>
     */
    public static Pointer tnpoint_at_stbox(Pointer arg0, Pointer arg1, boolean arg2) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=restriction</p>
     */
    public static Pointer tnpoint_minus_stbox(Pointer arg0, Pointer arg1, boolean arg2) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
     ...
     * <p>Classification: role=accessor</p>
     */
    public static long tnpoint_route(Pointer arg0) {
        if (!MEOS_AVAILABLE) {
            throw new UnsupportedOperationException(
