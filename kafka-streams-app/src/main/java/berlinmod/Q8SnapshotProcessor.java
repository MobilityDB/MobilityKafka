...
/**
 * BerlinMOD-Q8 — <b>snapshot form</b>, Kafka-Streams Processor API.
 *
 * <p><i>"At time T, which vehicles are within {@code d} metres of the road
 * segment (using each vehicle's most-recent-known position on or before
 * T)?"</i>
 *
 * <p>Same shape as {@link Q3SnapshotProcessor} with the point-to-segment
 * predicate substituted for the point-radius one.
 */
public class Q8SnapshotProcessor implements Processor<Integer, BerlinMODTrip, Long, Integer> {
    ...
    public Q8SnapshotProcessor(String storeName, double s1Lon, double s1Lat,
